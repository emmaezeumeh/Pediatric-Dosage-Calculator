...
def insertRecords():
    ...
    add_weight_records ="INSERT INTO Weight_Info(weight_kg) VALUES (%s)"
    weight_val= [
        ("5",), 
        ("10",), 
        ("15",), 
    ...
    add_strength_records ="INSERT INTO Strength_Info(dose_strength_mg_per_5ml) VALUES (%s)"
    strength_val= [
        ("125",), 
        ("200",), 
        ("250",), 
    ...
    add_duration_records = "INSERT INTO Duration_Info( duration_days) VALUES (%s)"
    duration_val= [
        ("5",), 
        ("10",), 
        ("14",)  
    ...
    # insert duration records
    add_dosing_rule_records = "INSERT INTO Dosing_Rule_Info( dosing_rule_mg_per_kg_per_day) VALUES (%s)"
    dosing_rule_val= [
        ("15",), 
        ("50",), 
        ("80",)  
    ...
    add_disease_records = "INSERT INTO Disease_Info(disease_type) VALUES (%s)"
    disease_val= [
        ("Acute Otitis Media",), 
        ("Allergy Relief",), 
        ("Pain Relief",) 
